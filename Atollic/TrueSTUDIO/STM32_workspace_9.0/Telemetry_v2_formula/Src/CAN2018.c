...
uint8_t * append_BBOX_power_Data(uint8_t *msg, uint16_t *msg_len) {
	...
	BBOX_power_Data.voltage = uint16++;
...
uint8_t * append_wheel_RPM_Data(uint8_t *msg, uint16_t *msg_len) {
	...
	// test data
	wheel_RPM_Data.front_right = uint16++;
	wheel_RPM_Data.front_left = uint16++;
	wheel_RPM_Data.rear_left = uint16++;
	wheel_RPM_Data.rear_right = uint16++;
...
uint8_t * append_BBOX_status_Data(uint8_t *msg, uint16_t *msg_len) {
	...
	BBOX_status_Data.STM_temp = int8++;
...
uint8_t * append_FU_Values_1(uint8_t *msg, uint16_t *msg_len) {
	...
	FU_Values_1_Data.apps1 = uint8++;
	FU_Values_1_Data.apps2 = uint8++;
	FU_Values_1_Data.brake1 = uint8++;
	FU_Values_1_Data.brake2 = uint8++;
	FU_Values_1_Data.error = uint16++;
...
uint8_t * append_BBOX_command(uint8_t *msg, uint16_t *msg_len) {
	...
	BBOX_command_Data.FANS =  uint8++;
	BBOX_command_Data.SHD_EN =  uint8++;
	uint8_t byte1 = 0;
...
uint8_t * append_BMS_State(uint8_t *msg, uint16_t *msg_len) {
	...
	BMS_State_Data.BMS_Mode = uint8++;
	BMS_State_Data.BMS_Faults = uint16++;
	BMS_State_Data.CellVolt_L = uint8++;
	BMS_State_Data.CellVolt_H = uint8++;
	BMS_State_Data.CellTemp_L = uint8++;
	BMS_State_Data.CellTemp_H = uint8++;
	BMS_State_Data.BMS_Ident = uint8++;
...
uint8_t * append_ECU_State(uint8_t *msg, uint16_t *msg_len) {
	...
	ECU_State_Data.ECU_Status = uint8++;
	ECU_State_Data.FL_AMK_Status = uint8++;
	ECU_State_Data.FR_AMK_Status = uint8++;
	ECU_State_Data.RL_AMK_Status = uint8++;
	ECU_State_Data.RR_AMK_Status = uint8++;
	ECU_State_Data.TempMotor_H = uint8++;
	ECU_State_Data.TempInverter_H = uint8++;
	ECU_State_Data.TempIGBT_H = uint8++;
...
uint8_t * append_FU_Values_2(uint8_t *msg, uint16_t *msg_len) {
	...
	FU_Values_2_Data.steer = int8 ++;
	FU_Values_2_Data.susp_FL = uint16++;
	FU_Values_2_Data.susp_FR = uint16++;
	FU_Values_2_Data.brake_pos = uint8++;
	FU_Values_2_Data.RTD = 1;
	FU_Values_2_Data.BOTS = 0;
	FU_Values_2_Data.SHDB = 1;
	FU_Values_2_Data.INERTIA_SW = 0;
	FU_Values_2_Data.reserve = uint8++;
...
uint8_t * append_Interconnect(uint8_t *msg, uint16_t *msg_len) {
	...
	Interconnect_Data.car_state = uint8++;
	...
	Interconnect_Data.reserve = uint8++;
	Interconnect_Data.susp_RR = uint16++;
	Interconnect_Data.susp_RL = uint16++;
...
uint8_t * append_BMS_Voltages(uint8_t *msg, uint16_t *msg_len) {
	...
	BMS_Voltages_Data.BMS_VoltIdent = iden % 20;
	BMS_Voltages_Data.BMS_Volt1 = uint8++;
	BMS_Voltages_Data.BMS_Volt2 = uint8++;
	BMS_Voltages_Data.BMS_Volt3 = uint8++;
	BMS_Voltages_Data.BMS_Volt4 = uint8++;
	BMS_Voltages_Data.BMS_Volt5 = uint8++;
	BMS_Voltages_Data.BMS_Volt6 = uint8++;
	BMS_Voltages_Data.BMS_Volt7 = uint8++;
...
uint8_t * append_BMS_Temps(uint8_t *msg, uint16_t *msg_len) {
	...
	BMS_Temps_Data.BMS_TempIdent = iden++ % 20;
	BMS_Temps_Data.BMS_Temp1 = uint8++;
	BMS_Temps_Data.BMS_Temp2 = uint8++;
	BMS_Temps_Data.BMS_Temp3 = uint8++;
	BMS_Temps_Data.BMS_Temp4 = uint8++;
	BMS_Temps_Data.BMS_Temp5 = uint8++;
	BMS_Temps_Data.BMS_Temp6 = uint8++;
	BMS_Temps_Data.BMS_Temp7 = uint8++;
