...
#define LORA_BASE_FREQUENCY_433            (433LLU*MHZ)

// Default settings
#define LORA_DEFAULT_TX_POWER              14		// default 17
#define LORA_DEFAULT_SF                    12		// default 7
#define LORA_DEFAULT_PREAMBLE_LEN          10
#define LORA_DEFAULT_RX_ADDR               0
#define LORA_DEFAULT_TX_ADDR               0
#define LORA_DEFAULT_SPI_TIMEOUT           1500 // ms

#define LORA_COMPATIBLE_VERSION            0x16U
